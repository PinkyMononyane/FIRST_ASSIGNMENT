...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("ClubMembersDBDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class ClubMembersDBDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As ClubMembersDBDataSet = CType(MyBase.Clone,ClubMembersDBDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "ClubMembersDBDataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/ClubMembersDBDataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As ClubMembersDBDataSet = New ClubMembersDBDataSet()
    ...
    Partial Public Class MEMBERSDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddMEMBERSRow(ByVal NAME As String, ByVal LASTNAME As String, ByVal DATE_OF_BIRTH As Date, ByVal GENDER As String, ByVal AGE As String, ByVal JOIN_DATE As String) As MEMBERSRow
            Dim rowMEMBERSRow As MEMBERSRow = CType(Me.NewRow,MEMBERSRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, NAME, LASTNAME, DATE_OF_BIRTH, GENDER, AGE, JOIN_DATE}
...
Namespace ClubMembersDBDataSetTableAdapters
    ...
    Partial Public Class MEMBERSTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[MEMBERS] ([NAME], [LASTNAME], [DATE_OF_BIRTH], [GENDER], [AGE]"& _ 
                ", [JOIN_DATE]) VALUES (@NAME, @LASTNAME, @DATE_OF_BIRTH, @GENDER, @AGE, @JOIN_DA"& _ 
                "TE);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT MEMBER_ID, NAME, LASTNAME, DATE_OF_BIRTH, GENDER, AGE, JOIN_DATE FR"& _ 
                "OM MEMBERS WHERE (MEMBER_ID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[MEMBERS] SET [NAME] = @NAME, [LASTNAME] = @LASTNAME, [DATE_OF_BIRTH"& _ 
                "] = @DATE_OF_BIRTH, [GENDER] = @GENDER, [AGE] = @AGE, [JOIN_DATE] = @JOIN_DATE W"& _ 
                "HERE (([MEMBER_ID] = @Original_MEMBER_ID) AND ((@IsNull_NAME = 1 AND [NAME] IS N"& _ 
                "ULL) OR ([NAME] = @Original_NAME)) AND ((@IsNull_LASTNAME = 1 AND [LASTNAME] IS "& _ 
                "NULL) OR ([LASTNAME] = @Original_LASTNAME)) AND ((@IsNull_DATE_OF_BIRTH = 1 AND "& _ 
                "[DATE_OF_BIRTH] IS NULL) OR ([DATE_OF_BIRTH] = @Original_DATE_OF_BIRTH)) AND ((@"& _ 
                "IsNull_GENDER = 1 AND [GENDER] IS NULL) OR ([GENDER] = @Original_GENDER)) AND (("& _ 
                "@IsNull_AGE = 1 AND [AGE] IS NULL) OR ([AGE] = @Original_AGE)) AND ((@IsNull_JOI"& _ 
                "N_DATE = 1 AND [JOIN_DATE] IS NULL) OR ([JOIN_DATE] = @Original_JOIN_DATE)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"S"& _ 
                "ELECT MEMBER_ID, NAME, LASTNAME, DATE_OF_BIRTH, GENDER, AGE, JOIN_DATE FROM MEMB"& _ 
                "ERS WHERE (MEMBER_ID = @MEMBER_ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT MEMBER_ID, NAME, LASTNAME, DATE_OF_BIRTH, GENDER, AGE, JOIN_DATE FROM dbo."& _ 
                "MEMBERS"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As ClubMembersDBDataSet.MEMBERSDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As ClubMembersDBDataSet.MEMBERSDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As ClubMembersDBDataSet.MEMBERSDataTable = New ClubMembersDBDataSet.MEMBERSDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As ClubMembersDBDataSet.MEMBERSDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As ClubMembersDBDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_MEMBER_ID As Integer, ByVal Original_NAME As String, ByVal Original_LASTNAME As String, ByVal Original_DATE_OF_BIRTH As Global.System.Nullable(Of Date), ByVal Original_GENDER As String, ByVal Original_AGE As String, ByVal Original_JOIN_DATE As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal NAME As String, ByVal LASTNAME As String, ByVal DATE_OF_BIRTH As Global.System.Nullable(Of Date), ByVal GENDER As String, ByVal AGE As String, ByVal JOIN_DATE As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal NAME As String, ByVal LASTNAME As String, ByVal DATE_OF_BIRTH As Global.System.Nullable(Of Date), ByVal GENDER As String, ByVal AGE As String, ByVal JOIN_DATE As String, ByVal Original_MEMBER_ID As Integer, ByVal Original_NAME As String, ByVal Original_LASTNAME As String, ByVal Original_DATE_OF_BIRTH As Global.System.Nullable(Of Date), ByVal Original_GENDER As String, ByVal Original_AGE As String, ByVal Original_JOIN_DATE As String, ByVal MEMBER_ID As Integer) As Integer
            If (NAME Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(18).Value = CType(Original_JOIN_DATE,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(19).Value = CType(MEMBER_ID,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal NAME As String, ByVal LASTNAME As String, ByVal DATE_OF_BIRTH As Global.System.Nullable(Of Date), ByVal GENDER As String, ByVal AGE As String, ByVal JOIN_DATE As String, ByVal Original_MEMBER_ID As Integer, ByVal Original_NAME As String, ByVal Original_LASTNAME As String, ByVal Original_DATE_OF_BIRTH As Global.System.Nullable(Of Date), ByVal Original_GENDER As String, ByVal Original_AGE As String, ByVal Original_JOIN_DATE As String) As Integer
            Return Me.Update(NAME, LASTNAME, DATE_OF_BIRTH, GENDER, AGE, JOIN_DATE, Original_MEMBER_ID, Original_NAME, Original_LASTNAME, Original_DATE_OF_BIRTH, Original_GENDER, Original_AGE, Original_JOIN_DATE, Original_MEMBER_ID)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As ClubMembersDBDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As ClubMembersDBDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._mEMBERSTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As ClubMembersDBDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._mEMBERSTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As ClubMembersDBDataSet) As Integer
